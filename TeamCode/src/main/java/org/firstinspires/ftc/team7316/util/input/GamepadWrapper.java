...
public class GamepadWrapper {
    ...
    public GamepadWrapper(Gamepad gamepad) {
        ...
        this.b_button = new SingleButtonPressWrapper(GamepadButton.B_BUTTON, this, 0);
        this.x_button = new SingleButtonPressWrapper(GamepadButton.X_BUTTON, this, 2);
        this.y_button = new SingleButtonPressWrapper(GamepadButton.Y_BUTTON, this, 1);
